...
def text_save(text, name):
    f = open('/home/preetham/Documents/Preetham/masters-thesis/results/gloss-to-grapheme/transformer/'+name, 'w', encoding='utf-8')
    f.write(text)
    f.close()
...
def main():
    ...
    val_inp = text_retrieve(file_name + '.gloss')
    val_tar = text_retrieve(file_name + '.en')
